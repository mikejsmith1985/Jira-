...
function buildReadmeText(version) {
  return [
    ...
    "TO UPDATE",
    "",
    "  You do not. The version showing in the top corner of Jira+ becomes a button",
    "  when there is a newer one. Click it and Jira+ fetches the new version,",
    "  restarts itself into it, and reloads the page. Your settings are untouched,",
    "  and the old version stays on disk in case you ever want it back.",
    "",
